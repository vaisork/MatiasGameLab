...
- **Cortafuegos de contaminación visual:** una criatura nueva es un arranque visual absoluto. No usa como referencia imágenes, prompts visuales ni anatomías de criaturas anteriores. Tampoco usa generaciones fallidas de la criatura actual como base de edición o variación.
- Antes de generar, reconstruye la criatura exclusivamente desde el canon escrito vigente en dos bloques: **ANATOMÍA OBLIGATORIA** (familia corporal, proporciones, locomoción, piel/escamas/pelo, extremidades, cabeza, cola y silueta) y **CONTAMINACIÓN PROHIBIDA** (rasgos heredados de trabajos anteriores que contradigan el canon).
- Si una generación reproduce la arquitectura corporal de una criatura descartada, se **descarta inmediatamente** y no se solicita una variación de esa imagen. El siguiente intento vuelve a construirse desde texto/canon limpio.
- Una imagen fallida nunca adquiere autoridad visual por repetición. Solo una validación anatómica **aprobada explícitamente por Dirección de Arte** puede convertirse en referencia visual obligatoria.
- Antes de entregar, realiza una autoverificación binaria contra los identificadores anatómicos obligatorios. Un fallo estructural (familia animal incorrecta, cobertura corporal incorrecta, disposición incorrecta de extremidades, cabeza/cola incompatibles o silueta equivocada) impide la entrega.
